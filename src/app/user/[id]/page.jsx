...
import { UserCircleIcon, BriefcaseIcon, CalendarIcon } from '@heroicons/react/solid';
...
const UserPage = ({ params }) => {
  ...
  useEffect(() => {
    const fetchUserpostsAndEvents = async () => {
      try {
        ...
        const UserpostsQuery = query(postCollection, where('userId', '==', UserId));
        ...
        const UserEventsQuery = query(eventCollection, where('userId', '==', UserId));
        ...
        console.error("Error fetching User's details, posts, and events: ", error);
      }
    };
  ...
  return (
    <div className="container mx-auto mt-8 mb-8 px-4">
      ...
      {posts.length === 0 && (
        <p className="text-center text-gray-600 mb-8">No posts found for this User.</p>
      )}
